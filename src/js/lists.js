...
class lists {
	...
	static init() {
		...
		var s = '', sqls =
			[
				{ label: 'log', sql: 'log.createdAt>{date-12h} and log.uri not like \'/support/%\' and log.uri not like \'/marketing/%\' and lower(ip.org) not like \'%facebook%\' and lower(ip.org) not like \'%google%\'' },
